...
//   bool get isFinished => isFinishedLost || isFinishedWon;
// }

// void test() {
//   GameStatus myStatus = GameStatus.loading;
//   if (myStatus.isFinishedLost) {}
// }
...
//   @override
//   List<Object> get props => [status,word,guessNo,errorMsg,grid];
// }

// Factory WordleState.initial()=>WordleState(status: GameStatus.loading, word: ' ', errorMsg: ' ', guessNo: 0 , grid: List.generate(30, (index) => Box(letter:'' ,status:BoxStatus.blank )));
// enum BoxStatus {
//   blank,
//   answered,
//   correct,
...
//   Box({required this.letter, required this.status});
// }
